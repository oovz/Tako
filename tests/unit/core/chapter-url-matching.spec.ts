...
describe("Chapter ID matching", () => {
  ...
  it("matches chapters by exact canonical ID", () => {
    const chapters = createChapters([
      {
        id: "ch-1001",
        url: "https://alpha.example/chapter/1001",
        title: "Chapter 1",
      },
      {
        id: "ch-1002",
        url: "https://alpha.example/chapter/1002",
        title: "Chapter 2",
      },
    ])
  ...
  it("does not match by URL when the ID differs", () => {
    ...
    const index = findChapterIndex(
      chapters,
      "https://alpha.example/chapter/1001"
    )
    expect(index).toBe(-1)
  })
  ...
  it("does not match by URL path aliases", () => {
    ...
    const index = findChapterIndex(
      chapters,
      "https://beta.example/chapter/1001"
    )
    expect(index).toBe(-1)
  })
  ...
  it("returns -1 when no chapter has the requested ID", () => {
    const chapters = createChapters([
      {
        id: "ch-2001",
        url: "https://alpha.example/chapter/2001",
        title: "Chapter 1",
      },
      {
        id: "ch-2002",
        url: "https://alpha.example/chapter/2002",
        title: "Chapter 2",
      },
    ])
...
describe("Edge cases for chapter matching", () => {
  ...
  it("still matches by ID even if URL metadata is malformed", () => {
    const chapters = [
      { id: "ch-1001", url: "invalid-url", title: "Ch1", status: "queued" },
    ]
