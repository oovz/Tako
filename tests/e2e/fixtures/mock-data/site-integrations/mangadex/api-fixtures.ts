 ...
 */
export const CUSTOM_MANGADEX_SERIES_FIXTURES: Record<
  string,
  CustomMangadexSeriesFixture
> = {
  [MANGADEX_ORDER_TEST_SERIES_ID]: {
    ...
    chapters: [
      {
        id: "standalone-1",
        url: buildExampleUrl("/standalone-1"),
        title: "Standalone chapter 1",
      },
      {
        id: "v2-c3",
        url: buildExampleUrl("/v2-c3"),
      ...
      {
        id: "standalone-2",
        url: buildExampleUrl("/standalone-2"),
        title: "Standalone chapter 2",
      },
      {
        id: "v2-c4",
        url: buildExampleUrl("/v2-c4"),
      ...
      {
        id: "standalone-3",
        url: buildExampleUrl("/standalone-3"),
        title: "Standalone chapter 3",
      },
      {
        id: "v2-c6",
        url: buildExampleUrl("/v2-c6"),
  ...
  [MANGADEX_GROUPED_COLLAPSE_SERIES_ID]: {
    ...
    chapters: [
      {
        id: "v1-c1",
        url: buildExampleUrl("/collapse-v1-c1"),
      ...
      {
        id: "v1-c2",
        url: buildExampleUrl("/collapse-v1-c2"),
      ...
      {
        id: "v2-c3",
        url: buildExampleUrl("/collapse-v2-c3"),
        title: "Volume 2 Chapter 3",
        chapterNumber: 3,
        volumeNumber: 2,
      },
  ...
  [MANGADEX_LOCKED_SELECTION_SERIES_ID]: {
    ...
    chapters: [
      {
        id: "locked-chapter-1",
        url: buildExampleUrl("/locked-chapter-1"),
 ...
 */
export function buildMangadexSeriesResponse(
  mangaId: string
): Record<string, unknown> {
  ...
  return {
    ...
    data: {
      ...
      attributes: {
        ...
        altTitles: [],
        description: {
          en: typeof meta.description === "string" ? meta.description : "",
        },
        status:
      ...
      relationships: [
        {
          ...
          type: "author",
          attributes: {
            name: typeof meta.author === "string" ? meta.author : "Author",
          },
        },
        {
          id: "cover-1",
