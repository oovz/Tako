...
export const ADULT_CHAPTERS: SiteIntegrationChapterDataset = {
  id: "MANHUAGUI_ADULT",
  description:
    "Adult-gated Manhuagui series chapter list (rendered via __VIEWSTATE decode)",
  chapters: [
    {
      id: "700001",
...
export const CATEGORY_CHAPTERS: SiteIntegrationChapterDataset = {
  ...
  description:
    "Manhuagui reference-style series grouped by category headings instead of numeric volumes",
  chapters: [
    {
      id: "378327",
...
export const KIMETSU_CHAPTERS: SiteIntegrationChapterDataset = {
  ...
  description:
    "Manhuagui 19430-style page with category headings, pagination controls, and visible page counts",
  chapters: [
    {
      id: "585094",
