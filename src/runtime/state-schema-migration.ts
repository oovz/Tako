...
const LegacyTaskChapterSchema = z
  .object({
    id: z.string().min(1),
    url: z.string().min(1),
    title: z.string(),
...
const LegacyTaskSettingsSnapshotSchema = z
  .object({
...
const LegacyDownloadTaskSchema = z
  .object({
    id: z.string().min(1),
...
const LegacyPendingUndoActionSchema = z
  .object({
...
const LegacyDownloadedChapterSchema = z
  .object({
...
const LegacyHistoryCutoffsSchema = z
  .object({
