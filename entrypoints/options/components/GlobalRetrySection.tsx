...
export function GlobalRetrySection({
  retries,
  onChange,
}: GlobalRetrySectionProps) {
  return (
    <Card>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-3">
            ...
            <Input
              ...
              value={retries.image}
              onChange={(e) =>
                onChange({ image: parseInt(e.target.value) || 0 })
              }
              className="font-mono"
            />
          ...
          <div className="flex flex-col gap-3">
            ...
            <Input
              ...
              onChange={(e) =>
                onChange({ chapter: parseInt(e.target.value) || 0 })
              }
              className="font-mono"
            />
            <p className="text-xs text-muted-foreground">
