...
export function GlobalStorageFormatSection({
  downloads,
      ...
      <CardContent className="flex flex-col gap-6">
        <div className="grid gap-6">
          <ArchiveFormatPicker
            ...
            onValueChange={(value) =>
              onDownloadsChange({ defaultFormat: value })
            }
          />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start justify-between p-4 rounded-lg border border-border bg-card">
              <div className="flex flex-col gap-1">
                <Label htmlFor="comicinfo">
                  {t("options_includeComicInfo")}
                </Label>
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  onDownloadsChange({ includeComicInfo: checked })
                }
              />
            </div>
            ...
            <div className="flex items-start justify-between p-4 rounded-lg border border-border bg-card">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  onDownloadsChange({ includeCoverImage: checked })
                }
              />
            </div>
            ...
            <div className="flex items-start justify-between p-4 rounded-lg border border-border bg-card">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  onDownloadsChange({ normalizeImageFilenames: checked })
                }
              />
            </div>
            ...
            <div className="flex items-start justify-between p-4 rounded-lg border border-border bg-card">
              <div className="flex flex-col gap-1">
                <Label htmlFor="suppress-save-as">
                  {t("options_suppressSaveAs")}
                </Label>
                <p className="text-xs text-muted-foreground pr-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              ...
              <Input
                ...
                onChange={(e) =>
                  onDownloadsChange({ pathTemplate: e.target.value })
                }
          ...
          <div className="flex flex-col gap-3">
            <Label htmlFor="image-padding" className="text-sm font-medium">
              {t("options_imagePadding")}
            </Label>
            <Select
