...
export function HistoryTab({
  ...
  const handleClearAll = async () => {
    await runConfirmedHistoryAction(onClearAll, () => {
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>
                    {t("options_clearAllDownloadHistory")}
                  </DialogTitle>
                </DialogHeader>
                <div className="flex flex-col gap-4">
                  <p className="text-sm">
                    {t("options_clearAllWarning", [
                      String(stats?.totalChapters ?? 0),
                      String(stats?.totalSeries ?? 0),
                    ])}
                  </p>
